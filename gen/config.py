...
BOUNDARY_TRAIN_PATH = 'data/loop/train.pkl'

CAD_VAL_PATH = 'data/profile/val.pkl'
BOUNDARY_VAL_PATH = 'data/loop/val.pkl'

CAD_TEST_PATH = 'data/profile/test.pkl'
BOUNDARY_TEST_PATH = 'data/loop/test.pkl'
ENCODER_CONFIG = {
    'hidden_dim': 512,
    'embed_dim': 256,  
    'num_layers': 6,   
